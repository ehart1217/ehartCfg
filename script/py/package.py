...
def package(main_path, plugin_root_list, plugin_apk_list):
    ...
    system('rm ./EReader/src/r1001/assets/plugins/*')
    ...
    for plugin_path in plugin_root_list:
        ...
        if plugin_path == '../plugin_audiobook':
            ...
            r = system('python ' + plugin_path + '/make.py -fr1001 -' + buildType)
        else:
            os.chdir(plugin_path)
    ...
    for plugin_apk in plugin_apk_list:
        r = system('mv ' + plugin_apk + ' ./EReader/src/x10/assets/plugins/')
        if r != 0:
...
if __name__ == '__main__':
    ...
    plugin_audio_apk_path = pluginAudioPath + '/app/build/outputs/plugin/r1001Release/plugin_audiobook.apk'
